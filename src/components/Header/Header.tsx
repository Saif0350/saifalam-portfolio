    ...
    <div className="z-10 fixed top-0 left-0 w-full py-5">
      <div className="container mx-auto max-w-[1600px] px-5 md:px-0">
        <div className="flex justify-between relative">
          ...
          <nav
            ref={menuRef}
            className={`nav-box absolute overflow-hidden invisible opacity-0 translate-y-[5px] top-[60px] right-0 bg-white/10 px-7 py-6 min-w-[250px] rounded-lg font-outfit text-xl backdrop-blur transition-all ease-linear duration-100 before:content-[''] before:absolute before:-z-[1] before:left-0 before:top-0 before:w-full before:h-full before:bg-themeGradient before:opacity-30 ${
              isMenuOpen ? "show" : ""
            }`}
          >
